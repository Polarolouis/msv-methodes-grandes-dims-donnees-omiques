...
<!-- TODO Détailler les matrices X et Y -->
```{r X_Y, echo = FALSE}
...
Le principe du blanchiment est de supprimer les corrélations existant entre 
les colonnes.
...
<!-- TODO Changer pour mentionner que c'est 3 methodes d'estimation de la dépendance -->
Pour cela le package R `MultiVarSel` (@perrot-dockesIntroductionMultiVarSel2019) 
implémente 3 méthodes pour blanchir les données en utilisant 3 structures de 
dépendance :
...
<!-- TODO Présenter la méthode de l'article, des simulations et l'appli aux données réelles -->

# Test de $\Sigma = Id$

```{r graphique_simulations, echo = FALSE, fig.height=4, fig.cap="$p-value$ pour le test basé sur la statistique T1"}
N <- 50
phi1 <- 0.5
...
```{r graphique_simu_T2, echo = FALSE, fig.height=4, fig.cap="p-value pour le test basé sur la statistique T2"}
ggplot(result) +
